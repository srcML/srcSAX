...
void srcSAXController::enable_charactersRoot(bool enable) {
    if(enable) context->handler->characters_root = cppCallbackAdapter::characters_root;
    else       context->handler->characters_root = 0;
}
...
void srcSAXController::enable_charactersUnit(bool enable) {
    if(enable) context->handler->characters_unit = cppCallbackAdapter::characters_unit;
    else       context->handler->characters_unit = 0;
}
...
void srcSAXController::enable_metaTag(bool enable) {
    if(enable) context->handler->meta_tag = cppCallbackAdapter::meta_tag;
    else       context->handler->meta_tag = 0;
}
